...
namespace wzxv
{
    class RadioStationNotificationManager
    {
        ...
        public void Notify(int notificationId, string Title, string SubTitle, Action<NotificationCompat.Builder> builder = null)
        {
            var notification = CreateNotificationBuilder(Title, SubTitle);
            if (builder != null)
            {
